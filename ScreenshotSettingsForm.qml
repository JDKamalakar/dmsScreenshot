...
Column {
    ...
    // Explicitly define implicit height so outer flickables know exactly how to scroll
    ...
    StyledRect {
        ...
        Column {
            ...
            // Replaced DankListView with Column + Repeater to allow scroll wheel passthrough
            Column {
                id: modeList
                width: parent.width
    ...
    StyledRect {
        ...
        Column {
            ...
            // Replaced DankListView with Column + Repeater
            Column {
                id: optionsList
                width: parent.width
